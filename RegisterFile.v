...
//
//
// Student(s) Name and Last Name: Ali Alaqeel - Logan Stonehouse
//
//
...
module RegisterFile(
    ...
    initial begin
        ...
        RegFile[27] = 0;
        RegFile[28] = 0; 
        RegFile[29] = 16387;        //Stack Pointer
        RegFile[30] = 0; 
        RegFile[31] = 0;
    end
	...
	//Writing Procedure
    always @(posedge Clk) begin //Consider maybe making it negedge for some applications
